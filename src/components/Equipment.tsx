      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {equipment.map((item, index) => (
            <div
              key={index}
              className="group bg-gradient-to-br from-white to-dental-light/30 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-dental-accent/30"
            >
        ...
        {/* Technology Benefits */}
        <div className="mt-16 bg-gradient-to-r from-dental-primary to-dental-secondary rounded-2xl p-8 lg:p-12 text-white">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-dental-accent rounded-full"></div>
